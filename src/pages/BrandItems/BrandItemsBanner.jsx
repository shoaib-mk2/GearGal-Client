        ...
        <div>
            <div className="carousel w-full">
                <div id="item1" className="carousel-item w-full">
                    ...
                    <div className="hero min-h-[60vh] bg-base-200">
                        <div className="hero-content md:gap-10 flex-col lg:flex-row">
                            <img src={productsByBrand[0]?.image} className="md:max-w-3xl" />
                            <div>
                                <h1 className="text-2xl font-bold">- Get Your Dream Car</h1>
                                <p className="text-4xl text-[#ff7700] italic">{productsByBrand[0]?.name}</p>
                ...
                <div id="item2" className="carousel-item w-full">
                    {/* <img src={productsByBrand[1].image} className="w-full" /> */}
                    <div className="hero min-h-[60vh] bg-base-200">
                        <div className="hero-content md:gap-10 flex-col lg:flex-row">
                            <img src={productsByBrand[1]?.image} className="md:max-w-3xl" />
                            <div>
                                <h1 className="text-2xl font-bold">- Get Your Dream Car</h1>
                                <p className="text-4xl text-[#ff7700] italic">{productsByBrand[1]?.name}</p>
                ...
                <div id="item3" className="carousel-item w-full">
                    {/* <img src={productsByBrand[2].image} className="w-full" /> */}
                    <div className="hero min-h-[60vh] bg-base-200">
                        <div className="hero-content md:gap-10 flex-col lg:flex-row">
                            <img src={productsByBrand[2]?.image} className="md:max-w-3xl" />
                            <div>
                                <h1 className="text-2xl font-bold">- Get Your Dream Car</h1>
                                <p className="text-4xl text-[#ff7700] italic">{productsByBrand[2]?.name}</p>
