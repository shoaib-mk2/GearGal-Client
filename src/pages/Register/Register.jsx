                ...
                <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                    <form className="card-body" onSubmit={handleRegister}>
                        ...
                        <div className="form-control mt-6">
                            <button className="btn btn-primary text-white bg-[#ff7700]">Register</button>
                        </div>
                    </form>
                </div>
                <p className="px-8 pb-4">Already have account? Please <Link className="font-bold text-[#ff7700]" to="/login">Login</Link></p>
            </div>
